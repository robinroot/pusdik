...
<body class="dark-edition">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="black" data-image="<?php echo base_url();?>assets/dashboard/img/sidebar-2.jpg">
      <!--
  ...
  <script src="<?php echo base_url();?>assets/dashboard/js/core/bootstrap-material-design.min.js"></script>
  ...
  <script src="<?php echo base_url();?>assets/dashboard/material-dashboard.js?v=2.1.0"></script>
