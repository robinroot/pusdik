    ...
    <div class="col-sm-12">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo base_url('staff/edit_berita/'.$row->id_berita);?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i>
                    </a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a href="<?php echo base_url('staff/delete_berita/'.$row->id_berita) ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Ya, Hapus</a>
