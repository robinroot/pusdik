...
// Form
echo form_open('staff/edit_kategori_berita/'.$row->id_kategori_berita);
?>
   	...
   	<div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url('staff/delete_kategori_berita/'.$row->id_kategori_berita) ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Ya, Hapus</a>
