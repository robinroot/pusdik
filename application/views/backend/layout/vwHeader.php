                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                                <!-- <a class="nav-link" href="<?php echo base_url($this->session->level.'/viewProfile')?>"><i class="fa fa- user"></i>My Profile</a> -->

                                <a class="nav-link" href="<?= base_url('dashboard/Logout');?>"><i class="fa fa-power -off"></i>Logout</a>
                        </div>
                    </div>
                </div>
            </div>
