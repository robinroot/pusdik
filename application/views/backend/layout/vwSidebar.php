            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-folder"></i><a href="<?php echo site_url('dashboard/berita'); ?>">Data Berita</a></li>
                        <li><i class="fa fa-plus"></i><a href="<?php echo base_url('dashboard/tambah_berita');?>">Tambah Berita</a></li>
                        <li><i class="fa fa-bars"></i><a href="<?php echo site_url('dashboard/kategori_berita'); ?>">Kategori Berita</a></li>
                ...
                <!--PROFILE-->
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Profil Website</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-th"></i><a href="<?php echo base_url('dashboard/profil');?>">Profil  </a></li>
                        <li><i class="menu-icon fa fa-th"></i><a href="forms-basic.html">Link Satuan</a></li>
                        <li><i class="menu-icon fa fa-th"></i><a href="forms-advanced.html">Pejabat</a></li>
                    </ul>
                </li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-th"></i><a href="<?= base_url('Dashboard/listcomment')?>">List Komentar</a></li>
                    </ul>
                </li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-th"></i><a href="<?= base_url('Dashboard/visitorberita')?>">Visitor Berita</a></li>
                        <li><i class="menu-icon fa fa-th"></i><a href="<?= base_url('Dashboard/visitorweb')?>">Visitor Website</a></li>
                    </ul>
                </li>
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-users"></i>User/Administrator</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-bars"></i><a href="<?php echo base_url('dashboard/show_account')?>">List akun</a></li>
                        <li><i class="menu-icon fa fa-user"></i><a href="<?php echo base_url('dashboard/viewProfile')?>">Ubah Username/Password</a></li>
                    </ul>
                </li>

                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-gear"></i>Konfigurasi Website</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-map-o"></i><a href="<?= base_url('dashboard/konfigurasi');?>">Konfigurasi Umum</a></li>
                        <li><i class="menu-icon fa fa-map-o"></i><a href="<?= base_url('dashboard/konfigurasi_quotes');?>">Quotes</a></li>
                        <li><i class="menu-icon fa fa-street-view"></i><a href="maps-vector.html">Logo</a></li>
                    </ul>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
